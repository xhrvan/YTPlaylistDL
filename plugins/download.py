...
Copyright (c) 2021 xhrvan <https://github.com/xhrvan>
    ...
    try:
        ...
        await c.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Join Now", url="https://t.me/tgxbotZ_update")
                    ]
                ]
            )
        )
        ...
        await c.send_message(
            chat_id=message.chat.id,
            text="Something went Wrong. Contact my [Support Group](https://t.me/tgxbotz_chat).",
            parse_mode="markdown",
            disable_web_page_preview=True)
        return False
